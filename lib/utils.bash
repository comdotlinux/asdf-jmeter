...
GH_REPO="https://jmeter.apache.org/"
...
# NOTE: You might want to remove this if jmeter is not hosted on GitHub releases.
...
install_version() {
  ...
  local release_file="$install_path/jmeter-$version.tar.gz"
  (
    ...
    local tool_cmd
    tool_cmd="$(echo "jmeter --version" | cut -d' ' -f1)"
